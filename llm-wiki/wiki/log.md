...
- Added source notes for assistant voice mode.
...
- Added follow-up source notes for assistant voice mode audio priming.
- Updated wiki page: `concepts/assistant-voice-mode.md`.
- Documents compact `Play`/`Mode`/`Resume`/`Stop` labels, explicit-play audio priming before TTS fetch, and light-theme kebab trigger styling.
- Updated `index.md`.

## 2026-06-08

- Added follow-up source notes for assistant voice mode autoplay sessions.
- Updated wiki page: `concepts/assistant-voice-mode.md`.
- Documents Chrome user-activation blocking, `Mode` no longer speaking the current answer, and silent autoplay-session retention between spoken answers.
- Updated `index.md`.

## 2026-06-08

- Added follow-up source notes for assistant voice mode Web Audio sessions.
- Updated wiki page: `concepts/assistant-voice-mode.md`.
- Documents replacing the primary HTML audio keep-alive with an `AudioContext` keep-alive and buffer playback path.
- Updated `index.md`.
