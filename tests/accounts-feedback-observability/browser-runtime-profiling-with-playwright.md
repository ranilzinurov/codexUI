...
#### Steps
1. Run `PROFILE_BASE_URL=http://127.0.0.1:4173 pnpm run profile:browser`
2. Run `PROFILE_BASE_URL=http://127.0.0.1:4173 PROFILE_ROUTE='#/thread/019da7c0-4e12-7a91-837c-f7c11cc8ab6c' pnpm run profile:browser`
